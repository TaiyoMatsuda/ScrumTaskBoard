...
export class ApiService {
  ...
  loginUser(authData) {
    ...
    return this.httpClient.post(`${this.rootUrl}authen/`,body,{headers:this.getAuthenHeaders()})
  }

  registerUser(authenData){
    const body = JSON.stringify(authenData)
    return this.httpClient.post(`${this.rootUrl}api/users/`,body,{headers:this.getAuthenHeaders()})
  }
